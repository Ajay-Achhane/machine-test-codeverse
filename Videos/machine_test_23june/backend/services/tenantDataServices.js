...
const tenantDataSchema = require("../models/tenantData");

const getModel = (tenantDb) => {
    return getTenantModel(tenantDb, "tenant_data", tenantDataSchema);
};

const tenantDataServices = {
...
module.exports = tenantDataServices;
